...
func Load() Config {
	...
	config.PostgresUser = cast.ToString(getOrReturnDefault("POSTGRES_USER", "khumoyun"))
	config.PostgresPassword = cast.ToString(getOrReturnDefault("POSTGRES_PASSWORD", "admin111"))
